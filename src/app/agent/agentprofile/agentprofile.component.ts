...
result2:any;
  ...
  ngOnInit() {
    this.ht.get(this.getAllServicesurl).subscribe(res=>{this.res2=res;
  ...
  //   'samagri': [null, Validators.required],
  //   'category_id': [null, Validators.required],
  //   'description':[null, Validators.pattern]
  // });
  ...
  actup(v) {
    ...
    // console.log("our data is :samagri"+v.samagri+"cost"+v.cost+"duration"+v.duration+"samagri_cost"+v.samagri_cost+"noofpandits"+v.noofpandits)
    if(this.f.invalid){
      return;
    }
